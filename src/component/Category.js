        ...
        return (
            <div>
                <div className='category'>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Iphone" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Samsung" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Oppo" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Sony" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Huawei" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Vivo" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Vsmart" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Realme" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Mobell" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Nokia" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="BlackBerry" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Lenovo" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Coolpad" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Ipad" /></Link>
                    <Link to='/porfolio'><input type='button' onClick={this.Search} value="Galaxy Tab" /></Link>
                </div>
                <div>
                    <form onSubmit={() => <Link to='/porfolio'>{this.handleFilterSubmit}</Link>}>
                        ...
                        <Link to='/porfolio'><button className='submitForm' onClick={this.handleFilterSubmit}>Search</button></Link>
                    </form>
                </div>
            </div>
