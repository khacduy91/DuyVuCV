        ...
        return (
            <div>
                <div className='category'>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Iphone" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Samsung" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Oppo" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Sony" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Huawei" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Vivo" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Vsmart" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Realme" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Mobell" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Nokia" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="BlackBerry" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Lenovo" /></Link>
                    <Link to='/porfolio/list'><input type='button' onClick={this.Search} value="Coolpad" /></Link>
                ...
                <div class='filterProducts'>
                    <form onSubmit={() => <Link to='/porfolio/list'>{this.handleFilterSubmit}</Link>}>
                        ...
                        <Link to='/porfolio/list'><button className='submitForm' onClick={this.handleFilterSubmit}>Search</button></Link>
                    </form>
                </div>
            </div>
